...
const CallToAction = () => {
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0'>
      ...
      <p className='text-gray-500 sm:text-sm'>Inciiunt sint fugiat pariatur cupidatat consectetur sit cillum anim id veniam alique prodient exceptur commodo do ea.</p>
